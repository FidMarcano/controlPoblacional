...
class adminController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (empty($encuestas)) {
           return view::make('home')->with(['n'=> 8, 'usuarios'=>$users, 'ciudades'=>$ciudades, 'aprobados'=>$aprobados,'materias'=>$materias, 'nuevos'=>$nuevos, 'encuestas' => 0, 'motivos' => $motivos, 'noP' => $noP, 'bloques'=>$bloques ]);
        }else{
